...
<head>
    ...
    <!-- Site Metas -->
    <title>Tea Factory Management System</title>
...
<body>
    ...
    <header class="top-navbar">
        <nav class="navbar navbar-expand-lg p-0 m-0 navbar-light bg-light">
            <div class="container">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdown-a">
                                ...
                                <a class="dropdown-item active" href="msg.php">Messages</a>
    ...
    <div class="container">
        ...
        <?php
$result = $conn->query("SELECT * FROM message") or die($mysqli->error);
//pre_r($result);
?>
            ...
            <table class="table table-hover table-sm" border="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="process/delete.php?delete=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                    </td>
                </tr>
                <?php endwhile ?>
            </table>
...
?>
        ...
        <!-- Start Footer -->
        <footer class="footer-area" style="margin-top: 150px;">
            <div class="copyright">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <p class="company-name">All Rights Reserved. &copy; 2020 <a href="#">Tea Factory Management
                                    System</a> Design By :
                                <a href="https://html.design/">Eloi & Aggee</a>
                            </p>
                        </div>
                    </div>
                </div>
